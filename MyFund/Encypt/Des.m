...
+ (NSString *) encode:(NSString *)str key:(NSString *)key
{
    ...
    NSMutableString* str1 = [Des urlEncode:str];
    NSMutableString* encode = [NSMutableString stringWithString:[Des doCipher:str1 key:key context:kCCEncrypt]];
    [Des formatSpecialCharacters:encode];
    return encode;
}
...
+ (NSString *) decode:(NSString *)str key:(NSString *)key
{
    ...
    [Des reformatSpecialCharacters:str1];
    NSString *rt = [Des doCipher:str1 key:key context:kCCDecrypt];
    return rt;
}
